...
- [Introduction to Cloud Foundry and Cloud Native Software Architecture (LFS132x) - Linux Foundation - Training](https://training.linuxfoundation.org/training/introduction-to-cloud-foundry-and-cloud-native-software-architecture/)
- [Cloud Foundry Explained - YouTube](https://www.youtube.com/watch?v=oUpqXxmr6oU)
...
- [Try Cloud Foundry | cloudfoundry-tutorials | Katacoda](https://katacoda.com/cloudfoundry-tutorials/scenarios/trycf)
